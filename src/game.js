...
/* ── 王之財寶（v1.132）─────────────────────────────
   三聲：門張開的能量嗡鳴、每一發射出去的金屬破空、打中的一聲脆響
   （插在土裡的另有一聲悶的）。
...
function sndBlade() { tone(2100, 0.09, 'sawtooth', 0.018, 0.32, 'blade'); noise(0.07, 0.035, 5200); }
function sndClang() { tone(760, 0.13, 'square', 0.022, 0.35, 'clang'); noise(0.13, 0.075, 2100); }
...
function sndThunder() {
  ...
  tone(40, THUNDER_ROLL * 0.8, 'sawtooth', 0.08, 0, 'thunder');
}
