  ...
  /* 積木池上限。**地標 ＋ 小人的村子兩份都要塞得下**，因為它們共用這一個池子：
     ...
     餘裕照舊：18000。多出來的 2000 格是 2000×(16+3) 個 float ≈ 152KB，一次性配置。
       · 城牆（v1.186，同一份 homes）：整圈的塊數是幾何算出來的，不靠預算擋——
         實測最大的那一座（金門大橋 9000 建材、牆半徑 94）是 **10616 塊**
         （一般的 1600 建材是 3384～5760）。牆是 3 格厚的空心牆，見 開發筆記〈事件二：城牆〉。
     所以再加一份：9932 ＋ 5405 ＋ 1800 ＋ 10616 ＝ 27753 → **28000**。
     成本：instanceMatrix 是 16 個 float ×28000 ≈ 1.8MB，一次性配置，不影響每幀；
